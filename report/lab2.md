...
- [Spark RegexTokenizer](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ml/feature/RegexTokenizer.html)
- [Spark HashingTF](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ml/feature/HashingTF.html)
- [Spark IDF](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ml/feature/IDF.html)

## 8. Model tạo sẵn, prompt sử dụng
- Không sử dụng pre-trained model ngoài, toàn bộ pipeline đều dùng các component built-in của Spark MLlib (RegexTokenizer, StopWordsRemover, HashingTF, IDF, LogisticRegression).
- Dataset sử dụng: C4 Common Crawl (data/c4-train.00000-of-01024-30K.json.gz)
- Không sử dụng prompt AI, chỉ dùng các hàm pipeline và dữ liệu thực tế.
